		...
		<div class="homepageheader">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton" style="">
					<a style="text-decoration: none; color: #fff;" href="/me/admin/login.php">Admin Login</a>
				</div> 
			</div>
							...
							<div>
								<form action="" method="POST" class="registration">
									<div class="signup_form">
										<?php
											if (isset($activacc)) {
												...
												echo '
													...
													<div>
														<td>
															<input name="acemail" placeholder="Enter Your Email" required="required" class="email signupbox" type="email" style= "color: #B0B0B0" size="30" value="'.$emails.'">
														</td>
													</div>
													<div>
														<td>
															<input name="actcode" placeholder="Activation Code" required="required" class="email signupbox" style= "color: #B0B0B0" type="text" size="30" value="'.$acccode.'">
														</td>
													</div>
													<div>
										...
										<div>
											<td>
												<input name="email" placeholder="Enter Your Email" required="required" class="email signupbox" type="email" style= "color: #B0B0B0" size="30" value="'.$emails.'">
											</td>
										</div>
										<div>
											<td>
												<input name="password" id="password-1" required="required"  placeholder="Enter Password" class="password signupbox" style= "color: #B0B0B0" type="password" size="30" value="'.$passs.'">
											</td>
										</div>
										<div>

	...
	try {
		...
		if(empty($_POST['quantity'])) {
			throw new Exception('Quantity can not be empty');
						...
						<font face="bookman">
							We will send you a verification <br> email very soon.
						</font></div></div>';
						}else{
	...
	<div class="holecontainer" style=" padding-top: 20px; padding: 0 20%">
		<div class="container signupform_content ">
			<div>
				...
				<h1 style="padding-bottom: 40px;"></h1>
						...
						<div>
							<form action="" method="POST" class="registration">
								<div class="signup_form" style="    margin-top: 38px;">
									<div>
										<td>
											<input name="mobile" placeholder="Your mobile number" required="required" class="email signupbox" type="text" style="color: #B0B0B0" size="30" value="'.$umob_db.'">
										</td>
									</div>
									<div>
										<td>
											<input name="address" id="password-1" required="required"  placeholder="Write your full address" class="password signupbox " style="color: #B0B0B0" type="text" size="30" value="'.$uadd_db.'">
										</td>
									</div>
									<div>
										<td>
											<select onchange="changeAmount()" name="quantity" required="required" id="productAmount" style=" font-size: 20px;
										font-style: italic; margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #000000;color: #B0B0B0;margin-left: 0;width: 300px;background-color: transparent;" class="">';
						...
						<ul style="float: left;">
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img"><a href="'.$category.'/view_product.php?pid='.$id.'">
									...
									<div style="text-align: center;color: #B0B0B0;padding: 0 0 6px 0;"> <span style="font-size: 15px;">'.$pName.'</span><br> Price: ₹ <span id="amountText">'.$price.'</span><span id="aHiddenText" style="display:none">'.$price.'</span></div>
								</div>

	...
	<div class="holecontainer" style=" padding-top: 20px; padding: 0 20%">
		<div class="container signupform_content ">
			<div>
				...
				<h2 style="padding-bottom: 20px;">Time for an Update!!!</h2>
						...
						<div>
							<form action="" method="POST" class="registration">
								<div class="signup_form">
									...
									<div>
										<td >
											<input name="descri" id="first_name" placeholder="Description" required="required" class="first_name signupbox" type="text" style= "color: #B0B0B0" size="30" value="'.$description.'" >
										</td>
									</div>
									<div>
										<td>
									...
									<div>
										<td>
											<input name="code" id="password-1" required="required"  placeholder="Code" class="password signupbox " type="text" style= "color: #B0B0B0" size="30" value="'.$code.'">
										</td>
									</div>
									<div>

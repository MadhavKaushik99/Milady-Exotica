		...
		<div class="homepageheader">
			<div class="signinButton loginButton">
				<div class="uiloginbutton signinButton loginButton" style="margin-right: 40px;">
					<a style="text-decoration: none;color: #FFFFFF" href="../signin.php">Sign Up</a>
				</div>
				<div class="uiloginbutton signinButton loginButton" style="">
					<a style="color: #fff; text-decoration: none;" href="../login.php">User Login</a>
				</div>
			</div>
							...
							<div>
								<form action="" method="POST" class="registration">
									<div class="signup_form">
										...
										<div>
											<td>
												<input name="password" id="password-1" required="required"  placeholder="Enter Password" class="password signupbox " style= "color: #B0B0B0" type="password" size="30" value="">
											</td>
										</div>
										<div>

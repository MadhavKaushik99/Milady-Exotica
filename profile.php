	...
	<div class="categories">
		<table>
			<tr>
				...
				<th><a href="women/braclets.php" style="text-decoration: none;color: #FFF;padding: 4px 12px;background-color: #857C7F;border-radius: 12px;">Bracelets</a></th>
			...
			<ul>
				<li style="float: left;">
					<div class="settingsleftcontent">
						<ul>
							<ul>
							<li><?php echo '<a href="profile.php?uid='.$user.'" style=" background-color: #FF5D5D; border-radius: 4px; color: #fff;" >My Orders</a>'; ?></li>
					...
					<div>
						<div>
							<table class="rightsidemenu">
								<tr style="font-weight: bold;" colspan="10" bgcolor="#857C7F"> 
									<th>Product Name</th>
									<th>Price</th>
									<th>Total Product</th>
									<th>Order Date</th>
